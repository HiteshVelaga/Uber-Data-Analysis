...
apr_data <- read.csv("F:\\Uber-dataset\\uber-raw-data-apr14.csv")
may_data <- read.csv("F:\\Uber-dataset\\uber-raw-data-may14.csv")
jun_data <- read.csv("F:\\Uber-dataset\\uber-raw-data-jun14.csv")
jul_data <- read.csv("F:\\Uber-dataset\\uber-raw-data-jul14.csv")
aug_data <- read.csv("F:\\Uber-dataset\\uber-raw-data-aug14.csv")
sep_data <- read.csv("F:\\Uber-dataset\\uber-raw-data-sep14.csv")
...
#PLOTTING OF THE DATA BY TRIPS DURING EVERYDAY OF THE MONTH  
